...
object.constructor=object.constructor||function(){Parent.apply(this,arguments);};var parent=Object(Parent.call(new F()));Object.mixin(this,parent);Object.mixin(this,object,_wrapParent);this.instanceOf=_instanceOf;if(this instanceof F){return this;}object.constructor.apply(this,arguments);};Child.Parent=Parent;return Child;};return Class;})();
